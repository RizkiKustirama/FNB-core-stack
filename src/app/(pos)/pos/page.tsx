...
export default function PosPage() {
  ...
  return (
    <div className="h-screen flex flex-col bg-[#FAF6F0] overflow-hidden select-none font-sans">
      {/* Top Header */}
      <PosHeader />
      ...
      {totalItemCount > 0 && (
        <div className="lg:hidden fixed bottom-4 left-4 right-4 z-30">
          <button
            ...
            className="w-full py-4 px-5 bg-[#C62828] hover:bg-[#a81c1c] text-white rounded-2xl shadow-xl flex items-center justify-between font-bold text-xs active:scale-[0.99] transition border border-white/20"
          >
            ...
            <div className="flex items-center gap-1.5 text-base font-serif font-extrabold">
      ...
      <div
        className={`fixed inset-x-0 bottom-0 top-12 bg-white z-50 rounded-t-3xl overflow-hidden transform transition-transform duration-300 ease-in-out lg:hidden shadow-2xl flex flex-col border-t border-[#2C221E]/10 ${
